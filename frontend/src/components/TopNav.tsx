        ...
        <div className="flex gap-2">
          {isLoggedIn && (
            <button 
              ...
              className={`px-4 py-2 rounded-lg uppercase tracking-wide text-sm transition-all ${
          ...
          {isLoggedIn ? (
            <button 
              onClick={onLogout}
              className="px-4 py-2 bg-retro-rust text-white rounded-lg uppercase tracking-wide text-sm hover:bg-retro-rust-dark transition-colors"
            >
              Wyloguj
            </button>
          ) : (
            <button 
              ...
              className="px-4 py-2 bg-retro-blue text-white rounded-lg uppercase tracking-wide text-sm hover:bg-retro-blue-dark transition-colors"
            >
              Logowanie
            </button>
          )}
